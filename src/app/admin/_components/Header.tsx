...
export const Header = () => {
return(
    <header className="bg-[#18181B] text-white w-[100%] h-[68px] flex justify-between pl-[100px] pr-[100px]">
        <img className="w-[146px] h-[44px]" src="LogoContainer.png" alt="header logo" />    
        <div className="flex justify-around  gap-[15px]">
            <div className="w-[251px] h-[36px] bg-white rounded-full flex justify-around">
            <GrLocation  className="text-red-500 "/>
            <button onClick={()=>Button} className="text-red-500 flex justify-between gap-1.5  size-[12px] "> Delivery address:</button>
            <button onClick={()=>Button} className="text-[#71717A] flex justify-between gap-1.5  size-[12px]"> Add Location </button>
